...
python scripts/generate_gsa_results.py     --dataset_root $SCENEFUN3D_ROOT     --dataset_config $SCENEFUN3D_CONFIG_PATH     --scene_id $SCENE_NAME     --class_set $CLASS_SET     --box_threshold 0.25     --text_threshold 0.25     --stride 1     --add_bg_classes     --accumu_classes     --exp_suffix withbg_allclasses
...
# detect 2D parts
# CUDA_VISIBLE_DEVICES=0 
python scripts/generate_part_gsa_results.py     --dataset_root $SCENEFUN3D_ROOT     --dataset_config $SCENEFUN3D_CONFIG_PATH     --scene_id $SCENE_NAME     --class_set $CLASS_SET     --box_threshold 0.15     --text_threshold 0.15     --stride 1     --add_bg_classes     --accumu_classes     --exp_suffix withbg_allclasses
